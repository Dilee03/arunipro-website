    ...
    <div className="bg-primary text-white text-sm py-2">
      <div className="mx-auto max-w-7xl px-6 flex justify-between items-center">
        <div className="flex items-center gap-4">
          <a href="tel:+14165650101" className="flex items-center gap-1 hover:text-secondary transition">
            <Phone className="h-3.5 w-3.5" />
            <span>416-565-0101</span>
          </a>
          <span className="text-white/30">|</span>
          <a href="tel:+14165654576" className="flex items-center gap-1 hover:text-secondary transition">
            <Phone className="h-3.5 w-3.5" />
            <span>416-565-4576</span>
          </a>
          <span className="text-white/30 hidden sm:inline">|</span>
          <a href="mailto:itax365@gmail.com" className="hidden sm:flex items-center gap-1 hover:text-secondary transition">
